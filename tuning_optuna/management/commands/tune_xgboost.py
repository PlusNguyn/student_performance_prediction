...
from tuning_optuna.tuning import TuningPaths, tune_xgboost
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS("Optuna tuning completed."))
        self.stdout.write(f"Best RMSE: {-summary['best_value']:.4f}")
